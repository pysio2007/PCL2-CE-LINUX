        ...
        Try
            ...
            For i = 1 To VersionCodes.Count - 1
                ...
                Try
                    ...
                    Dim ReleaseDate As New Date(
                        Convert.ToInt32(ReleaseTimeSplit(0)), '年
                        Convert.ToInt32(ReleaseTimeSplit(1)), '月
                        Convert.ToInt32(ReleaseTimeSplit(2)), '日
                        Convert.ToInt32(ReleaseTimeSplit(3)), '时
                        Convert.ToInt32(ReleaseTimeSplit(4)), '分
                        Convert.ToInt32(ReleaseTimeSplit(5)), '秒
                        0, DateTimeKind.Utc) '毫秒和时区
